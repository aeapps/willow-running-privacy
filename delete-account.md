# Delete Your Willow Running Club Account
  ...
  ## Option 1: Delete in-app (instant)

  If you still have the Willow Running Club app installed and can sign in:
  ...
  - Your profile, including first name, last name, email address, date of birth, gender, and phone number if provided
  - Every activity you have logged, including date, distance, and event tag
  - Your authentication record

  There is no recovery once an account is deleted.
  ...
  **accessible.ethical@proton.me** with:
  ...
  within seven business days. We will reply again when the deletion is complete.

  ## What we keep, and for how long

  Once deletion is complete:

  - All profile data and activity history is removed immediately from our database.
  - Server logs that include IP addresses and connection timestamps may be retained for up to 90 days for security and
  abuse-prevention purposes. These logs are not linked to your identity after the account is deleted.
